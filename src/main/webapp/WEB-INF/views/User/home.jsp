                ...
                <div class="selector">
                    <form class="form__selector" action="User/home.htm" method="POST">
                        ...
                        <div class="form-element">
                            ...
                            <div class="checkbox-group">
                                <div class="checkbox__element">
                                    <input style="max-width: 75%" type="number" name="fromPrice" placeholder="Từ">
                                    <input style="max-width: 75%" type="number" name="toPrice" placeholder="Đến">
                                </div>
                            </div>
                        </div>
                        <div class="form-element">
                            ...
                            <div class="checkbox-group">
                                <div class="checkbox__element">
                                    <input id="check__type-all" type="checkbox" name="nameCategory" value="all" checked="checked"> Tất cả
                                </div>
